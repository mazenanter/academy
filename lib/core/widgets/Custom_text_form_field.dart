      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(
            icon ?? Icons.email,
            size: 22.sp,
            color: iconColor ?? ColorsManager.lightGreyColor,
          ),
          // labelText: "Email address or phone number",
          hintText: text,
          hintStyle: textStyle ?? TextStylesManager.font14LighterGreyRegular,
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(borderRadius ?? 10.r),
            borderSide: BorderSide(color: Colors.white), // non-focused border
          ),
